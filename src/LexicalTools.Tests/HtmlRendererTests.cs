...
namespace WeSay.LexicalTools.Tests
{
	...
	public class HtmlRendererTests
	{
		...
		public void LexEntry_Unassigned_Focused_Throws()
		{
			...
			Assert.Throws<ArgumentNullException>(() => HtmlRenderer.ToHtml(_entry, _currentItem, _lexEntryRepository));
		}
		[Test]
		public void NullEntryReturnsEmptyString()
		{
			String html = HtmlRenderer.ToHtml(null, _currentItem, _lexEntryRepository);
			Assert.IsEmpty(html);
		}
		[Test]
		public void ConversionTest()
		{
			String html = HtmlRenderer.ToHtml(_entry, _currentItem, _lexEntryRepository);
			Assert.IsTrue(html.Contains("contentEditable='false'"));
		}
		[Test]
		public void HomographEntryTest()
		{
			String html = HtmlRenderer.ToHtml(anotherApple, _currentItem, _lexEntryRepository);
...
/*		[Test]
		public void TestCase()
		{
			...
			string html = HtmlRenderer.ToHtml(entry, currentItem, lexEntryRepository);
